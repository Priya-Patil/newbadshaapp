...
public class CitynameHomeAdapter extends RecyclerView.Adapter<CitynameHomeAdapter.MyViewHolder> {
    ...
    public CitynameHomeAdapter(Activity context, ArrayList<HomeModel> list) {
        this.list = list;
        mContext = context;
    }

    public CitynameHomeAdapter(Activity context, ArrayList<HomeModel> list, ItemClickListener itemClickListener){
        mContext = context;
        this.list = list;
    ...
    public  MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_item_for_daily_quiz, null);
