...
import com.m90.badshahandicappertips.general.adapter.NumberDetailsRoundRaceAdapter;
...
public class RaceCardActivity extends AppCompatActivity implements View.OnClickListener {
   ...
   // ArrayList<TotalPlateNumberDetailsModel> roundarrayList ;
    ...
    NumberDetailsRoundRaceAdapter numberDetailsRoundAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity=RaceCardActivity.this;
        progressDialog=new ProgressDialog(RaceCardActivity.this);
        ...
        binding.txtTitle.setText("Race card");
       ...
       // String url="http://badsha.cricketnewshub.xyz/public/api/racecarda?venue="+rvenue+"&date="+rdate+"&table_no=1";
        String url=getResources().getString(R.string.base_url)+"racecarda?active1="+active1+"&venue="+rvenue+"&date="+rdate+"&table_no=1";
        Log.e( "onCreate: ",url );
...
//            Log.e( "roundarrayList: ", totalPlateNumberDetailsModels.toString() );
    ...
    private void bindList(final ArrayList<TotalPlateNumberDetailsModel> totalPlateNumberDetailsModels) {
        ...
        try {
            ...
            binding.rlRound.setLayoutManager(new LinearLayoutManager(RaceCardActivity.this,
                    LinearLayoutManager.HORIZONTAL, false));
            binding.rlRound.setItemAnimator(new DefaultItemAnimator());
            binding.rlRound.setHasFixedSize(true);

            numberDetailsRoundAdapter = new NumberDetailsRoundRaceAdapter(this, totalPlateNumberDetailsModels,
                    new NumberDetailsRoundRaceAdapter.ItemClickListener() {
                        @Override
                        public void onClick(View view, int position) {

                            plateDetails(rvenue,rdate,totalPlateNumberDetailsModels.get(position).r);
                            String url=getResources().getString(R.string.base_url)+"racecarda?active1="+active1+"&venue="+rvenue+"&date="+rdate+"&table_no="+totalPlateNumberDetailsModels.get(position).r;
                            loadWebViewLoad(binding.webview, url);
