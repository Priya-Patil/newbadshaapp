...
public class NumberDetailsRoundAdapter extends RecyclerView.Adapter<NumberDetailsRoundAdapter.MyViewHolder> {
    ...
    public NumberDetailsRoundAdapter(Activity context, ArrayList<TotalPlateNumberDetailsModel> list) {
        this.list = list;
        mContext = context;
    }

    public NumberDetailsRoundAdapter(Activity context, ArrayList<TotalPlateNumberDetailsModel> list, ItemClickListener itemClickListener){
        mContext = context;
        this.list = list;
