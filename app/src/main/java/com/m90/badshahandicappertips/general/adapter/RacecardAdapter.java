...
public class RacecardAdapter extends RecyclerView.Adapter<RacecardAdapter.MyViewHolder> {
    ...
    public RacecardAdapter(Activity context, ArrayList<HomeModel> list) {
        this.list = list;
        mContext = context;
    }

    public RacecardAdapter(Activity context, ArrayList<HomeModel> list, ItemClickListener itemClickListener){
        mContext = context;
        this.list = list;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            tv_title = itemView.findViewById(R.id.txt_date);
