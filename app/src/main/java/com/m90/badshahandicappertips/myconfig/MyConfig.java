...
public class MyConfig {
    ...
    final public static String ROOT_URL = "http://test.eurekatalents.in/";
    ...
    public static String getLoginUrl(String mobile_number,String password){

        return BASE_URL+"login?mobile_number="+mobile_number+"&password="+password;
    }

    public static String getFogUrl(String mobile_number,String password){

        return BASE_URL+"login?mobile_number="+mobile_number+"&password="+password;
    }

 //   http://test.eurekatalents.in/api/register?course_id=1&name=demo1&mobile_number=2222222266&email=pppp@jj.com&password=888888&password_confirmation=888888

    public static String getRegUrl(String course_id, String name,String mobile_number,String email,String password,String password_confirmation){
        return BASE_URL+"register?course_id="+course_id+"&name="+name+"&mobile_number="+mobile_number+"&email="+email+"&password="+password+"&password_confirmation="+password_confirmation;
    }
    public static String attendance_data_send(String id,String atten,String date,String mClass,String mSection){

        return BASE_URL+"student-attendance-store?id="+id+"&attendance="+atten+"&date="+date+"&class="+mClass+"&section="+mSection;
    }
    ...
    public static String getSubjectsUrl(int id){
        return BASE_URL+"study-material/1";
    }
...
return category;
   ...
   public static String urlReg=BASE_URL+"register";
   public static String urlCourse=BASE_URL+"course";
   public static String urlGetProfile=BASE_URL+"student/";
   public static String urlGetFees=BASE_URL+"fees/";
   public static String urlGetSubjects=BASE_URL+"course/subject/";
   public static String urlGetSubjectContent=BASE_URL+"course/content/";
   public static String urlDashboard=BASE_URL+"dashboard/";
   public static String urlAllNotification=BASE_URL+"notification";
   public static String urlUpdateProfile=BASE_URL+"student/update";
   public static String urlChangePass=BASE_URL+"password/change";
